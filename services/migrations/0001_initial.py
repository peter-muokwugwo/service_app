    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature_image', models.ImageField(blank=True, help_text='A representing image for this category.', null=True, upload_to=services.help_functions.upload_to_service, verbose_name='Category Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Service Price')),
                ('quantity', models.PositiveIntegerField(default=1, help_text='Number of services requested.', verbose_name='Quantity')),
                ('moving_help_charge', models.DecimalField(blank=True, decimal_places=2, help_text='Additional charge for moving help.', max_digits=10, null=True, verbose_name='Moving Help Charge')),
