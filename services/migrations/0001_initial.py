# Generated by Django 5.2 on 2025-05-17 23:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('needs_moving_help', models.CharField(choices=[('YES', 'Yes'), ('NO', 'No')], default='NO', help_text='Whether moving help is required.', verbose_name='Moving Help')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(default=1, help_text='Number of this service option in the cart.', validators=[django.core.validators.MinValueValidator(1)], verbose_name='Quantity')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
            ...
            options={
                ...
                'ordering': ['cart'],
                'indexes': [models.Index(fields=['cart'], name='services_ca_cart_id_0aa10a_idx')],
